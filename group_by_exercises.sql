...
-- DOUBLE CHECKING: SHOULD BE 5 ROSALYN BAALENs
SELECT first_name, last_name, emp_no FROM employees WHERE first_name = 'Rosalyn' AND last_name = 'Baalen';
...
SELECT COUNT(first_name), gender FROM employees WHERE first_name IN ('Vidya', 'Irena', 'Maya') GROUP BY gender;